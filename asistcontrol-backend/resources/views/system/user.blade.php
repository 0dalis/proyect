                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="px-3 py-2 whitespace-nowrap text-sm">
                                        @if($user->is_active)
                                            <span class="inline-block px-2 py-0.5 text-xs bg-green-100 text-green-800 rounded-full">
                                                Activo
                                            </span>
                                        @else
                                            <span class="inline-block px-2 py-0.5 text-xs bg-red-100 text-red-800 rounded-full">
                                                Inactivo
                                            </span>
                                        @endif
                                    </td>
