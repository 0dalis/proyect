                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($permissions as $permission)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $permission->created_at->format('d/m/Y H:i') }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <a href="#" data-action="update"
                                        class="editPermission inline-flex items-center px-2 py-1 text-indigo-600 hover:text-indigo-900"
                                        data-id="{{ $permission->id }}"
                                        data-name="{{ $permission->name }}"
                                        data-tippy-content="Editar Permiso">
                                            <i class="bi bi-pencil-fill"></i>
                                        </a>
                                        <a href="#" class="deletePermission inline-flex items-center px-2 py-1 text-red-600 hover:text-red-900"
                                            data-id="{{ $permission->id }}"
                                            data-name="{{ $permission->name }}">
