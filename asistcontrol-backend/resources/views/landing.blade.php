    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-3">
                <a href="{{ route('acceso') }}#registro" class="text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white px-3 py-2 transition-colors">
                    Regístrate
                </a>
                <a href="http://localhost:4200/login" title="Si ya tienes una cuenta inicia sesión" class="inline-flex items-center justify-center px-4 py-2 bg-brand-600 hover:bg-brand-500 text-white text-xs font-semibold rounded-lg shadow-md shadow-brand-600/30 hover:shadow-brand-500/50 transition-all hover:-translate-y-0.5">
                    Inicia Sesión
                </a>
        ...
        <div id="mobileMenu" class="md:hidden hidden pb-6 pt-2 border-t border-slate-200 dark:border-slate-800/60 space-y-3">
            ...
            <div class="pt-4 border-t border-slate-200 dark:border-slate-800/80 flex flex-col gap-2">
                <a href="{{ route('acceso') }}#registro" class="block px-3 py-2 text-center text-sm font-semibold text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-800 rounded-lg">Regístrate</a>
                <a href="http://localhost:4200/login" title="Si ya tienes una cuenta inicia sesión" class="block px-3 py-2 text-center text-sm font-semibold text-white bg-brand-600 rounded-lg">Inicia Sesión</a>
                    ...
                    @foreach($planes as $plan)
                        <div :style="getStyle({{ $loop->index }})"
                            ...
                            <div class="relative bg-white dark:bg-slate-900 border rounded-xl p-8 flex flex-col justify-between h-[520px] transition-all duration-300"
                                ...
                                <a href="{{ route('acceso') }}?plan={{ urlencode($plan->nombre) }}"
