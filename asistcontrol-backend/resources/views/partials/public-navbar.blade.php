    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-3">
                ...
                <a href="http://localhost:4200/login" title="Si ya tienes una cuenta inicia sesión" class="inline-flex items-center justify-center px-4 py-2 bg-brand-600 hover:bg-brand-500 text-white text-xs font-semibold rounded-lg shadow-sm shadow-brand-600/20 transition-all">
                    Inicia Sesión
                </a>
