                    ...
                    <tr>
                        <td style="padding: 36px 36px 28px 36px; background-color: #ffffff;">
                            ...
                            <div style="text-align: center; margin-bottom: 32px;">
                                <span style="font-size: 12px; color: #4f46e5; font-weight: 600; background-color: #f5f3ff; padding: 6px 16px; border-radius: 20px; border: 1px solid #e0e7ff; display: inline-block;">
                            ...
                            <!-- Fallback Enlace -->
                            <div style="margin-top: 32px; background-color: #f5f3ff; padding: 16px; border-radius: 8px; border: 1px solid #e0e7ff;">
                                ...
                                <p style="font-size: 11px; color: #4f46e5; word-break: break-all; margin: 0; font-family: monospace; font-weight: 600;">
                                    {{ $verificationUrl }}
                                </p>
                            </div>
                    ...
                    <tr>
                        <td style="background-color: #f5f3ff; padding: 24px 36px; text-align: center; border-top: 1px solid #e0e7ff;">
                            <p style="font-size: 11px; color: #64748b; margin: 0 0 6px 0; line-height: 1.5;">
                                Has recibido este correo porque tu empresa registró una cuenta en <a href="{{ route('landing') }}" target="_blank" style="color: #4f46e5; text-decoration: underline; font-weight: 600;">AsistControl</a>.
                            </p>
